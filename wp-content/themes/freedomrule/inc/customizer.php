 ...
 */
function freedomrule_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'freedomrule_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector' => '.site-description',
			'container_inclusive' => false,
			'render_callback' => 'freedomrule_customize_partial_blogdescription',
		) );
	}
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'freedomrule_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'freedomrule' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => freedomrule_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'freedomrule' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'freedomrule' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'freedomrule' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'freedomrule' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'freedomrule' );
}
add_action( 'customize_register', 'freedomrule_customize_register', 11 );

/**
 * Render the site title for the selective refresh partial.
 *
 * @since Twenty Fifteen 1.5
 * @see freedomrule_customize_register()
 *
 * @return void
 */
function freedomrule_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function freedomrule_customize_partial_blogdescription() {
 ...
 *
 * Can be filtered with {@see 'freedomrule_color_schemes'}.
 *
 ...
 */
function freedomrule_get_color_schemes() {
	/**
	 ...
	 * }
	 */
	return apply_filters( 'freedomrule_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'freedomrule' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
...
if ( ! function_exists( 'freedomrule_get_color_scheme' ) ) :
/**
 ...
 */
function freedomrule_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = freedomrule_get_color_schemes();
...
endif; // freedomrule_get_color_scheme

if ( ! function_exists( 'freedomrule_get_color_scheme_choices' ) ) :
/**
 ...
 */
function freedomrule_get_color_scheme_choices() {
	$color_schemes                = freedomrule_get_color_schemes();
...
endif; // freedomrule_get_color_scheme_choices

if ( ! function_exists( 'freedomrule_sanitize_color_scheme' ) ) :
/**
 ...
 */
function freedomrule_sanitize_color_scheme( $value ) {
	$color_schemes = freedomrule_get_color_scheme_choices();
...
endif; // freedomrule_sanitize_color_scheme
 ...
 */
function freedomrule_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = freedomrule_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = freedomrule_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = freedomrule_get_color_scheme_css( $colors );

	wp_add_inline_style( 'freedomrule-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'freedomrule_color_scheme_css' );
 ...
 * @since Twenty Fifteen 1.0
 */
function freedomrule_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', freedomrule_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'freedomrule_customize_control_js' );
 ...
 * @since Twenty Fifteen 1.0
 */
function freedomrule_customize_preview_js() {
	wp_enqueue_script( 'freedomrule-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'freedomrule_customize_preview_js' );
 ...
 */
function freedomrule_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function freedomrule_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-freedomrule-color-scheme">
		<?php echo freedomrule_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'freedomrule_color_scheme_css_template' );
